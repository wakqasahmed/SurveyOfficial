angular.module('oi.multiselect', ['/lib/oi.multiselect/template/multiselect/template.html']);

angular.module("/lib/oi.multiselect/template/multiselect/template.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/lib/oi.multiselect/template/multiselect/template.html",
...
.directive('oiMultiselect', ['$document', '$q', '$timeout', '$parse', '$interpolate', '$injector', '$filter', 'oiUtils', 'oiMultiselect', function($document, $q, $timeout, $parse, $interpolate, $injector, $filter, oiUtils, oiMultiselect) {
    ...
    return {
        restrict: 'AE',
        templateUrl: '/lib/oi.multiselect/template/multiselect/template.html',
        require: 'ngModel',
        scope: {},
